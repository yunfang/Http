...
import appdemo.http.configure.Config;
        ...
        x.http().post(entity, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (mRequestCallback != null) {
                    if (r != null && r.getCode().equals("200")) {//r != null && r.getCode() == BaseResult.OK
...
//    }
     ...
     * @return 对象自身
     */
    public Request<R> addArgument(HashMap<String, Object> map) {
//        if (!isObjectToStringNull(argument)) {
//            mArguments.put(key, argument.toString());
//        }
        mArguments = map;
